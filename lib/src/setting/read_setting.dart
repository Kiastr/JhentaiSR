...
class ReadSetting with JHLifeCircleBeanWithConfigStorage implements JHLifeCircleBean {
  ...
  RxBool enableAnime4K = false.obs;
  RxDouble anime4KScaleFactor = 2.0.obs;
  RxDouble anime4KPushStrength = 0.31.obs;
  ...
  void applyBeanConfig(String configString) {
    ...
    enableAnime4K.value = map['enableAnime4K'] ?? enableAnime4K.value;
    anime4KScaleFactor.value = map['anime4KScaleFactor'] ?? anime4KScaleFactor.value;
  ...
  String toConfigString() {
    return jsonEncode({
      ...
      'enableAnime4K': enableAnime4K.value,
      'anime4KScaleFactor': anime4KScaleFactor.value,
  ...
  Future<void> saveEnableAnime4K(bool value) async {
    log.debug('saveEnableAnime4K:$value');
    enableAnime4K.value = value;
    await saveBeanConfig();
  }

  Future<void> saveAnime4KScaleFactor(double value) async {
    log.debug('saveAnime4KScaleFactor:$value');
    anime4KScaleFactor.value = value;
    await saveBeanConfig();
  }

  Future<void> saveAnime4KPushStrength(double value) async {
    log.debug('saveAnime4KPushStrength:$value');
    anime4KPushStrength.value = value;
    await saveBeanConfig();
  }

  Future<void> saveAnime4KPushGradStrength(double value) async {
    log.debug('saveAnime4KPushGradStrength:$value');
    anime4KPushGradStrength.value = value;
    await saveBeanConfig();
  }
