...
import '../pages/setting/advanced/colorization/setting_colorization_page.dart';
...
class Routes {
  ...
  static const String colorization = "/setting_advanced/colorization";
  ...
  static List<EHPage> pages = <EHPage>[
    ...
    EHPage(
      name: colorization,
      page: () => const SettingColorizationPage().withEscOrFifthButton2BackRightRoute(),
      transition: defaultTransition,
      offAllBefore: false,
    ),
    EHPage(
